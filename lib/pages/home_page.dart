...
import 'package:venera_netmatic/pages/downloading_page.dart';
import 'package:venera_netmatic/pages/follow_updates_page.dart';
import 'package:venera_netmatic/pages/history_page.dart';
import 'package:venera_netmatic/pages/image_favorites_page/image_favorites_page.dart';
...
import 'package:venera_netmatic/utils/import_comic.dart';
  ...
  Widget build(BuildContext context) {
    var widget = SmoothCustomScrollView(
      slivers: [
        ...
        const _History(),
        const _Local(),
        const SchedulerHomeCard(),
        const StorageHomeCard(),
    ...
    return ContentDialog(
      ...
      actions: [
        Button.text(
          ...
          onPressed: () {
            launchUrlString(
              "https://github.com/Piaomobai/venera-netmatic/blob/main/doc/import_comic.md",
            );
          },
