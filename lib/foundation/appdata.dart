...
class Settings with ChangeNotifier {
  ...
  final _data = <String, dynamic>{
    ...
    'nasConnections': [], // device-local NAS credentials and destinations
    'defaultNasConnectionId': null,
    'nasSyncedComics':
        <String, dynamic>{}, // device-local incremental NAS markers
