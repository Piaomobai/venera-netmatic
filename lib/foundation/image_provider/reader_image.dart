...
class ReaderImageProvider
  ...
  const ReaderImageProvider(
    ...
    this.externalBytesLoader,
    this.externalCacheKey,
  });
  ...
  final Future<Uint8List> Function(String imageKey)? externalBytesLoader;

  final String? externalCacheKey;
  ...
  Future<Uint8List> load(chunkEvents, checkStop) async {
    ...
    if (externalBytesLoader != null) {
      checkStop();
      imageBytes = await externalBytesLoader!(imageKey);
      checkStop();
  ...
  @override
  String get key => externalBytesLoader == null
      ? "$imageKey@$sourceKey@$cid@$eid@$enableResize"
      : "external@$externalCacheKey@$imageKey@$sourceKey@$cid@$eid@$enableResize";
}
