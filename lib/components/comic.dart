...
class ComicTile extends StatelessWidget {
  ...
  final Widget? Function(Comic comic)? overlayBuilder;
  ...
  Widget build(BuildContext context) {
    ...
    final overlay = overlayBuilder?.call(comic);
    if (!isFavorite && history == null && overlay == null) {
      return child;
    }
    ...
    return Stack(
      children: [
        ...
        if (overlay != null) Positioned(right: 8, top: 8, child: overlay),
      ],
    );
  }
